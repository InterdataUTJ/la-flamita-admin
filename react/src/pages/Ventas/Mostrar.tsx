                ...
                <div className="space-y-2">
                    {Venta.empleado_id && (
                        <dl className="flex items-center justify-between gap-4">
                            <dt className="text-base font-normal text-gray-500">ID del Empleado</dt>
                            <dd className="text-base font-medium text-gray-900">{Venta.empleado_id}</dd>
                        </dl>
                    )}

                    {Venta.cliente_id && (
                        <dl className="flex items-center justify-between gap-4">
                            <dt className="text-base font-normal text-gray-500">ID del Cliente</dt>
                            <dd className="text-base font-medium text-gray-900">{Venta.cliente_id}</dd>
                        </dl>
                    )}

                    <dl className="flex items-center justify-between gap-4">
                        <dt className="text-base font-normal text-gray-500">Fecha de la venta</dt>
                        <dd className="text-base font-medium text-gray-900">{timestamp.format(Venta.fecha_venta)}</dd>
                    </dl>

                    <dl className="flex items-center justify-between gap-4">
                        <dt className="text-base font-normal text-gray-500">Fecha de pago</dt>
                        <dd className="text-base font-medium text-gray-900">{timestamp.format(Venta.fecha_pago)}</dd>
                    </dl>
