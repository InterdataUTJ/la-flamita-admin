  ...
  return (
    <div className="mb-5">
      ...
      <InputType
        ...
        type={type}
        name={props.name}
        className={`${props.disabled ? "bg-gray-100 text-gray-600" : "bg-gray-50 text-gray-900"} rounded-lg shadow-sm border ${ errorMsg ? "border-red-600 focus:ring-red-600 focus:border-red-600" : "border-gray-300 focus:ring-primary-500 focus:border-primary-500" } text-sm rounded-l-lg block w-full p-2.5`}
