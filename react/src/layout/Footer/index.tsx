    ...
    <footer className="bg-white shadow border-t-2 border-gray-200 mt-4">
      <div className="w-full max-w-screen-xl mx-auto p-4 md:py-8">
        <div className="sm:flex sm:items-center sm:justify-between">
          <div className={`flex items-center mb-4 sm:mb-0 space-x-3 rtl:space-x-reverse ${!auth.token ? "flex-1 justify-center" : ""}`}>
          ...
          { !!auth.token && (
            <ul className="flex flex-wrap items-center mb-6 text-sm font-medium text-gray-500 sm:mb-0 dark:text-gray-400">
              <li>
                <Link to="/panel" className="hover:underline hover:text-primary-600 me-4 md:me-6">
                  Panel
                </Link>
              </li>
              <li>
