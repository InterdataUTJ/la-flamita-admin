...
@section('contenido')
    <h2 class="text-center font-extrabold text-3xl mb-8 mt-4">Crear categoría</h2>
    <div class="mt-4">
        <form action="/categoria/store" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-5">
                ...
                <textarea id="descripcion" name="descripcion" rows="5" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-primary-500 focus:border-primary-500" placeholder="Descripción..." minlength="3" required></textarea>
            </div>
            ...
            <div id="categoria-valores-contenedor" class="mb-2 flex flex-col gap-2">
                ...
                <div class="flex">
                    <input type="text" name="valores[]" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-l-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5"
                        placeholder="Nombre" required minlength="3" maxlength="50" />
