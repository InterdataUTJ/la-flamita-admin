...
<main class="w-11/12 max-w-screen-sm mx-auto pt-5">
    ...
    <form class="mb-10" action="/singup" method="POST" enctype="multipart/form-data">
        ...
        <div class="mb-5">
            ...
            <input type="text" name="nombre" id="nombre" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-400 block w-full p-2.5" placeholder="John" maxlength="50" required />
        </div>
        
        <div class="mb-5">
            <label for="apellido" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Apellido</label>
            <input type="text" name="apellido" id="apellido" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-400 block w-full p-2.5" placeholder="Doe" maxlength="50" required />
        </div>
        ...
        <div class="mb-5">
            ...
            <x-password placeholder="Contraseña" maxlength="50" required name="clave2" />
        </div>
        ...
        <p class="text-sm text-gray-500 dark:text-gray-400">
            ¿Ya tienes una cuenta? <a href="/login" class="font-bold text-primary-600 hover:underline">Inicia sesión</a>
        </p>
    </form>
    ...
    <div class="flex flex-col gap-3">
        ...
        <a href="/empleado/login" class="w-full text-fifth font-bold rounded-lg text-sm px-5 py-2.5 text-center inline-flex flex items-center justify-center gap-2 border border-quaternary-600 text-quaternary-600 hover:bg-gray-100 active:bg-gray-200 cursor-pointer select-none">
