...
<main class="w-11/12 max-w-screen-sm mx-auto pt-5">
    ...
    <div class="flex flex-col gap-3">
        <a href="#" class="w-full text-black font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex flex items-center justify-center gap-2 border border-black hover:bg-gray-100 active:bg-gray-200">
