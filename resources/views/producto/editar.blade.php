    ...
    <div class="mt-4">
        <form action="/producto/update/{{ $producto->id }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-5">
                ...
                <input class="block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 focus:ring-primary-500 focus:border-primary-500" id="fotos" name="fotos[]" type="file" multiple accept="image/jpeg, image/png, image/jpg, image/gif, image/svg">
            </div>
