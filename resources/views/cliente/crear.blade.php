        ...
        <form action="/cliente/store" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-5">
                ...
                <input type="password" id="clave" name="clave" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500 dark:shadow-sm-light"
                    placeholder="••••••••••••" required minlength="8" maxlength="255" />
            </div>
            <div class="mb-5">
                ...
                <div class="mt-1 text-sm text-gray-500-" id="user_avatar_help">Selecciona tu avatar</div>
            </div>
                <button type="submit" class="block w-full text-white bg-primary-500 hover:bg-primary-400 focus:ring-4 focus:outline-none focus:ring-primary-400 font-medium rounded-lg text-sm px-5 py-2.5 text-center active:bg-primary-600">Crear cuenta</button>
        </form>
    </div>
