...
@section('contenido')
    <h2 class="text-center font-extrabold text-3xl mb-8 mt-4">Crear empleado</h2>
    <div class="mt-4">
        <form action="/empleado/store" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="mb-5">
            ...
            <div class="mb-5">
                ...
                <input type="text" id="correo" name="correo" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500 dark:shadow-sm-light"
                    placeholder="ejemplo@laflamita.com" required maxlength="255" minlength="5" />
            </div>
            <div class="mb-5">
            ...
            <div class="mb-7">
                ...
                <div class="mt-1 text-sm text-gray-500 mb-3" id="user_avatar_help">Selecciona un avatar</div>
