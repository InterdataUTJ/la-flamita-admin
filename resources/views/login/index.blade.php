...
<main class="w-11/12 max-w-screen-sm mx-auto pt-5">
    ...
    <form class="mb-10">
        ...
        <button type="submit" class="w-full text-black font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex flex items-center justify-center gap-2 hover:bg-gray-100 active:bg-gray-200 text-white bg-second/90 hover:bg-second/85 active:bg-second">
    ...
    <div class="flex flex-col gap-3">
        <button type="button" class="w-full text-black font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex flex items-center justify-center gap-2 border border-black hover:bg-gray-100 active:bg-gray-200">
        ...
        <a class="w-full text-fifth font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex flex items-center justify-center gap-2 border border-fifth hover:bg-gray-100 active:bg-gray-200 cursor-pointer select-none">
